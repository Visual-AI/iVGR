...
def reduce_metrics(metrics: dict[str, list[Any]]) -> dict[str, Any]:
    """Reduce metrics by computing the mean of each list.
    
    Uses nanmean to ignore NaN values when computing averages.
    This is important for group-specific metrics where some samples
    may have NaN values for metrics that don't apply to their group.
    """
    reduced = {}
